import { AFFILIATION_TO_NAME_MAP, CONFIGURATION_TO_NAME_MAP, EXTENSION_TO_NAME_MAP, PERSPECTIVE_TO_NAME_MAP, } from "../generate/index.js";
 ...
 */
export function glossCa(ca, isAffix) {
    const segments = [
        ca.affiliation == "CSL" || !ca.affiliation ?
            GlossString.of("")
            : new GlossString(ca.affiliation, asGloss(AFFILIATION_TO_NAME_MAP[ca.affiliation])),
        ca.configuration == "UPX" || !ca.configuration ?
            GlossString.of("")
            : new GlossString(ca.configuration, asGloss(CONFIGURATION_TO_NAME_MAP[ca.configuration])),
        ca.extension == "DEL" || !ca.extension ?
            GlossString.of("")
            : new GlossString(ca.extension, asGloss(EXTENSION_TO_NAME_MAP[ca.extension])),
        ca.perspective == "M" || !ca.perspective ?
            GlossString.of("")
            : new GlossString(ca.perspective, asGloss(PERSPECTIVE_TO_NAME_MAP[ca.perspective])),
        ca.essence == "RPV" ?
