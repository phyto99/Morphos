...
export declare const SHEET = "1JdaG1PaSQJRE2LpILvdzthbzz1k_a0VT86XSXouwGy8";
/** The range containing the data in the lexicon sheet. */
export declare const ROOTS = "Roots(Positional order)!A2:X";
/** The range containing the data in the affixes sheet. */
export declare const AFFIXES = "Affixes!A2:M";
