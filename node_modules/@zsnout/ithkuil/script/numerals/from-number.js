import { attachConstructor, Secondary, textToSecondaries, } from "../index.js";
 ...
 */
export function numericAdjunctToNumerals(number, handwritten) {
 ...
 */
export function numericCxToSecondaries(value, getCx, handwritten) {
