import { ALL_CASES_SKIPPING_DEGREE_8, ALL_ILLOCUTIONS, ALL_VALIDATIONS, deepFreeze, has, } from "../../generate/index.js";
 ...
 */
export function Quaternary(quaternary) {
    let top;
    let bottom;
    ...
    if (quaternary.type) {
        return Secondary({
            ...
            superposed: quaternary.type == 2 ? "DOT"
        ...
        return Secondary({
            handwritten: quaternary.handwritten,
            superposed: quaternary.mood ? MOOD_TO_DIACRITIC_MAP[quaternary.mood] : undefined,
            top,
            core: "STRESSED_SYLLABLE_PLACEHOLDER",
            bottom,
