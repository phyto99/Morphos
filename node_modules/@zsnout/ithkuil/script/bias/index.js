...
import { Anchor, Diacritic, Secondary } from "../index.js";
...
export function Bias(props) {
    ...
    if (props.bias == "DCC") {
        g.appendChild(_jsx(Anchor, { at: "cc", x: -12.5, y: -12.5, children: _jsx(Diacritic, { handwritten: props.handwritten, name: "DOT" }) }));
    }
    if (props.bias == "PSM") {
        g.appendChild(_jsx(Anchor, { at: "cc", x: 12.5, y: -12.5, children: _jsx(Diacritic, { handwritten: props.handwritten, name: "DOT" }) }));
    }
