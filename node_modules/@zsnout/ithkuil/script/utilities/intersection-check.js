...
let svg;
function _doPathsIntersect(a, b, margin = 10) {
    if (!svg) {
        svg = (_jsx("svg", {}));
    }
    const el = (_jsx("path", { d: b, "stroke-width": 2 * margin, "stroke-linecap": "round", "stroke-linejoin": "round", stroke: "red" }));
    svg.append(el);
 ...
 */
export function doPathsIntersect(a, b, margin = 10) {
 ...
 */
export function doShapesIntersect(a, b, margin = 10) {
    const pathsA = [
        ...(a instanceof SVGPathElement ? [a] : a.getElementsByTagName("path")),
    ]
        .map((x) => x.getAttribute("d") || "")
        .filter((x) => x);
    const pathsB = b instanceof SVGPathElement ? [b] : b.getElementsByTagName("path");
