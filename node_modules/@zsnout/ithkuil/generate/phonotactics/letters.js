 ...
 */
export function extractAllVowels(text) {
 ...
 */
export function extractAllConsonants(text) {
 ...
 */
export function extractInitialConsonantCluster(text) {
 ...
 * @returns The matched cluster, or `undefined` is no such cluster exists.
 */
export function extractFinalConsonantCluster(text) {
 ...
 * @returns The matched cluster, or `undefined` is no such cluster exists.
 */
export function extractInitialVowelCluster(text) {
 ...
 * @returns The matched cluster, or `undefined` is no such cluster exists.
 */
export function extractFinalVowelCluster(text) {
