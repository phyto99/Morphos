...
export class WithWYAlternative {
    ...
    add(other) {
        ...
        return new WithWYAlternative(this.defaultValue + other.withPreviousText(this.defaultValue), this.valueAfterW + other.withPreviousText(this.valueAfterW), this.valueAfterY + other.withPreviousText(this.valueAfterY));
    }
    /**
    ...
    insertGlottalStop(isAtEndOfWord) {
        return new WithWYAlternative(insertGlottalStop(this.defaultValue, isAtEndOfWord), insertGlottalStop(this.valueAfterW, isAtEndOfWord), insertGlottalStop(this.valueAfterY, isAtEndOfWord));
    }
}
