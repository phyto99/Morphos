 ...
 */
export function stressVowelForm(vowelForm) {
 ...
 */
export function countVowelForms(text) {
 ...
 */
export function applyStress(word, position) {
    ...
    const stressType = position == -1 ? "ultimate"
