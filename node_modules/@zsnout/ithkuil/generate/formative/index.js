...
import {} from "./shortcut-type.js";
import { slotIToIthkuil } from "./slot-1/index.js";
import { applySlotXStress } from "./slot-10/index.js";
import { SLOT_II_MAP, SLOT_II_SHORTCUT_MAP, slotIIToIthkuil, } from "./slot-2/index.js";
import {} from "./slot-3/index.js";
import { slotIVToIthkuil, } from "./slot-4/index.js";
...
import { caseScopeToIthkuil, moodToIthkuil, slotVIIIToIthkuil, } from "./slot-8/index.js";
import { ALL_CASES, slotIXToIthkuil, } from "./slot-9/index.js";
...
function completeFormativeToIthkuil(formative) {
    const slot3 = typeof formative.root == "string" ? formative.root
    ...
    let slot4 = slotIVToIthkuil(formative, {
        slotIII: slot3,
        affixualFormativeDegree: typeof formative.root == "object" && !isArray(formative.root) ?
    ...
    if (slotVIIAffixes.length != 0 &&
        ...
        const shortcut = (finalSlotVIIAffix &&
    ...
    if (formative.slotVAffixes.length == 0 &&
        (formative.shortcut === true ||
            ...
            const shortcut = essence == "RPV" ?
                ...
                : perspective == "M" && extension == "PRX" ?
                    ...
                    : extension == "DEL" ?
                        ...
                        : null;
            const shortcutType = essence == "RPV" ?
                perspective == "M" && extension == "DEL" ?
                    "y" // RPV
                    : perspective == "G" && extension == "DEL" ?
                        "y" // G / RPV
    ...
    if (formative.type == "FRM") {
        if (countVowelForms(slot1 + slot2 + slot3 + slot4 + slot5 + slot6 + slot7) <
            2 &&
            slot2 == "" &&
            formative.vn == "MNO" &&
            formative.caseScope == "CCN") {
        ...
        if (countVowelForms(slot1 + slot2 + slot3 + slot4 + slot5 + slot6 + slot7 + slot8 + slot9) < 3 &&
            slot2 == "") {
            slot2 = "a";
        }
        const word = slot1 + slot2 + slot3 + slot4 + slot5 + slot6 + slot7 + slot8 + slot9;
 ...
 * @returns Romanized Ithkuilic text representing the formative.
 */
export function formativeToIthkuil(formative) {
