...
export const ALL_EFFECTS = /* @__PURE__ */ deepFreeze([
    "1:BEN",
    "2:BEN",
    "3:BEN",
    "SLF:BEN",
 ...
 */
export function effectToIthkuil(effect) {
 ...
 */
export function effectToEffectObject(effect) {
 ...
 */
export function effectObjectToEffect(effectObject) {
