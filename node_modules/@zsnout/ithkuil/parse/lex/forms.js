...
const GEMINATE = /* @__PURE__ */ anyText("pp", "bb", "tt", "dd", "kk", "gg", "ff", "vv", "ţţ", "ḑḑ", "ss", "zz", "šš", "žž", "çç", "xx", "ļļ", "cc", "żż", "čč", "jj", "mm", "nn", "ňň", "rr", "ll", "řř");
 ...
 * y-, or h-).
 */
export const C = /* @__PURE__ */ seq(standardConsonant, 
 ...
 * or h-).
 */
export const H = /* @__PURE__ */ seq(specialConsonant, 
/* @__PURE__ */ consonant.zeroOrMore());
/**
...
/* @__PURE__ */ seq(standardConsonant, consonant.zeroOrMore()).optional(), GEMINATE, 
/* @__PURE__ */ consonant.zeroOrMore());
/**
...
/* @__PURE__ */ seq(consonant.zeroOrMore(), GEMINATE).not(), standardConsonant, 
/* @__PURE__ */ consonant.zeroOrMore());
/** Either `CNG` or `N`. */
