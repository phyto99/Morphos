 ...
 */
export const singleOrDualReferential = /* @__PURE__ */ seq(any(seq(text("üo"), anyText("hl", "hm", "hn", "hň").asGroup()), 
// Slot I: C1
seq(text("ë").optional(), C, seq(text("ë"), C).zeroOrMore()).asGroup()), 
// Slot II: Vc1
V.asGroup(), seq(anyText("w", "y"), 
// Slot III: Vc2
V.asGroup(), seq(
// Slot IV: C2
C.asGroup(), text("ë").optional()).optional()).optional())
    .matchEntireText()
    .compile();
