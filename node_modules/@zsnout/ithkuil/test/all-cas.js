import { ALL_AFFILIATIONS, ALL_CONFIGURATIONS, ALL_ESSENCES, ALL_EXTENSIONS, ALL_PERSPECTIVES, attemptGemination, caToIthkuil, geminatedCAToIthkuil, } from "../generate/index.js";
            ...
            for (const extension of ALL_EXTENSIONS) {
                for (const perspective of ALL_PERSPECTIVES) {
                    ...
                    console.log(([
                        ...
                        .filter((x) => x)
                        .join("-") || "[default Ca]").padEnd(20, " "), result.padEnd(8, " "), (attemptGemination(result) == result ?
                        geminate + "*"
                        : geminate).padEnd(12, " "), [affiliation, configuration, extension, perspective, essence].join("-"));
                }
            }
        }
    }
